...
import parser,index,search,relevance_feedback_1,rocchio_algorithm
...
if __name__ == '__main__':
    ...
    # if relevant_command == '' or non_relevant_command =='' :
    #     return
    ...
    # search.run(searcher, analyzer,relevant_command,non_relevant_command,relevant_scoreDocs,retrived_scoreDocs)
    relevant_scoreDocs,retrived_scoreDocs=search.run(searcher, analyzer,relevant_command,non_relevant_command,relevant_scoreDocs,retrived_scoreDocs)
    print('recall and precision after Rocchio Algorithm','\n')
    # print(len(relevant_scoreDocs))
